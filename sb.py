...
import json, time, random, codecs, tempfile, os, sys, pytz, urllib, re, ast, string, six, requests, html5lib, urllib3, threading, traceback, atexit
                    ...
                    if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                        ...
                        if msg.contentType == 0:
                            ...
                            if cmd == '!me':
                              ...
                              if sender not in creator:
                                pass
                                  ...
                                  if sender not in user:
                                     user[sender] = 0
                                  if user[sender] >= 5:
                                     client.sendMessage(to,'Batas pemakaian 10 pesan.')
                                  else:
                              ...
                              try:
                                ...
                                if len(cond) == 1:
                                    ...
                                    if num <= len(data["results"]):
                                        ...
                                        client.sendMessage(to, str(lyric))
                              ...
                              if sender in creator:
                                ...
                                for manusia in n:
                                  ...
                                  pass
                                   ...
                                   client.leaveGroup(to)
                                    ...
                                    X.preventedJoinByTicket = False
                                    client.updateGroup(X)
                                    client.sendText(to,"Link QR Terbuka")
                            elif cmd == "!closeurl":
                                    X = client.getGroup(to)
                                    X.preventedJoinByTicket = True
                                    client.updateGroup(X)
                                    client.sendText(to,"Link QR Tertutup")
                                ...
                                try:
                                    ...
                                    if data["find"] == True:
                                        if data["media"]["mediatype"] == 1:
                                            client.sendImageWithURL(to, str(data["media"]["url"]))
                                        if data["media"]["mediatype"] == 2:
                                            client.sendVideoWithURL(to, str(data["media"]["url"]))
                                        ret_ = "╔══[ Info Post ]"
                                ...
                                link = "http://line.me/ti/p/~fakhrads"
                                iconlink ="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWbDftD-kEKNnwISBfhwQyAVXXRu8WWedQdsGpPGnzUaTH9BdD"
                                client.sendMessageWithContent(to,helpMessage,nam,link,iconlink)
                            elif msg.text.lower() == '!changelog':
                                client.sendText(to,changeLog)
                            elif cmd == '!speed':
                                start = time.time()
                                ...
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    try:
                                        ...
                                        client.sendMessage(to, "Sukses di clone!")
                                    except:
                                        client.sendMessage(to, "Gagal clone member")
                              ...
                              if user[sender] >= 1:
                                ...
                                if msg.to in read['readPoint']:
                                        ...
                                        with open('sider.json', 'w') as fp:
                                            ...
                                            client.sendMessage(to,"Ceksider sudah diaktifkan")
                                else:
                                    try:
                                        del read['readPoint'][msg.to]
                                        del read['readMember'][msg.to]
                                ...
                                if msg.to not in read['readPoint']:
                                    client.sendMessage(to,"Ceksider sudah dimatikan")
                                else:
                                    try:
                                            del read['readPoint'][msg.to]
                                            del read['readMember'][msg.to]
                                          ...
                                          pass
                                    client.sendMessage(to, "Deleted reading point:\n" + readTime)
                                ...
                                if msg.to in read["readPoint"]:
                                    ...
                                    client.sendMessage(to, "Ceksider belum diaktifkan ngapain di reset?")
                        ...
                        #             client.sendMessage(to, "Berhasil masuk ke group %s" % str(group.name))
                                ...
                                try:
                                    ...
                                    del read['point'][receiver]
                                    del read['sidermem'][receiver]
                                    del read['cyduk'][receiver]
                                except:
                                    pass
                                read['point'][receiver] = msg.id
                                read['sidermem'][receiver] = ""
                                read['cyduk'][receiver]=True
                            elif cmd == '!cek':
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                day = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday","Friday", "Saturday"]
                                ...
                                for k in range(0, len(bulan)):
                                    if bln == str(k): bln = bulan[k-1]
                                readTime = hasil + ", " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y') + "\nJam : [ " + timeNow.strftime('%H:%M:%S') + " ]"
                                if msg.to in read['point']:
                                    client.sendText(receiver,'Yang membaca:' + read['sidermem'][msg.to] + '\n\nTanggal:\n' + readTime)
                                else:
